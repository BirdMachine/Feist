...
This repository is the development home for **Birdie Photo Maid** (testing version v0.3.1), aimed first at Kestrel — Galaxy S21 Ultra 5G / SM-G998U1.
...
- `Feist-BirdiePhotoMaid-v0.3.1-debug.apk`
- `Feist-BirdiePhotoMaid-v0.3.1-debug.apk.sha256`
